               ...
               with font-awesome or any other icon font library -->
						<li class="nav-item">
							<a href="<?= base_url('Layout/dashboard') ?>"
								class="nav-link <?= ($controller == 'Layout') ? 'active' : '' ?>">
						...
						<li
							class="nav-item has-treeview <?= ($controller == 'siswa' || $controller == 'kelas') ? 'menu-open' : '' ?>">
							<a href="#"
								class="nav-link <?= ($controller == 'siswa' || $controller == 'kelas') ? 'active' : '' ?>">
